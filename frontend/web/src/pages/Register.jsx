    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Join the Fitness Community</p>
        </div>
          ...
          <div className="bg-slate-900/60 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 border border-slate-800/50">
            <div className="mb-8">
              ...
              <p className="text-slate-400 text-sm">Start your fitness journey today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full px-4 py-3.5 bg-slate-950/50 border border-slate-700/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 transition-all duration-200"
                >
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-slate-900/60 px-4 text-slate-500">Already a member?</span>
              </div>
            </div>
